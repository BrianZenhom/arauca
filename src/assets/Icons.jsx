export default function LogoComplete({ isScrolled }) {
  return (
    <svg
      className={isScrolled ? 'logoMain' : 'logoMain_small'}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 811.23 151.55"
    >
      <g>
        <rect
          id={isScrolled ? 'shown' : 'invisible'}
          x="501.88"
          y="2.23"
          width="32.11"
          height="27.37"
