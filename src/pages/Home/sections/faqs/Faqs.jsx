...
const data = [
  ...
  },
  {
    ...
    answer:
      `¡Pero claro que si! Siempre y cuando sea dentro de los primeros 14 días naturales desde la recepción del pedido, el producto debe estar con su embalaje original, sus etiquetas y sin ningún tipo de daño o modificación de su estado inicial. Pero te adelantamos que te encantará, ¡No querrás devolverlo!`,
  },
  {
    question: '¿Cómo localizo mi pedido?',
    answer:
      `En el momento de la compra y que enviemos tu pedido recibirás un correo con la confirmación de compra y un número de tracking con la empresa de envíos para que puedas hacer el seguimiento cuando tú quieras`,
  },
  {
    question: '¿Cuáles son las formas de pago?',
    answer:
      `Para nosotros tu seguridad, tu tranquilidad y bienestar, está primero. Por eso te contamos que tenemos un certificado de seguridad SLL que hace a tus datos invisibles y completamente encriptados para los “amigos de lo ajeno “. 
  ...
  },
  {
    ...
    answer:
      `Todavía no nos conocemos muy bien, pero te adelantamos que en nuestras fotos encontrarás a los modelos con su altura y la talla que está usando.
